...
class ReportFinancialController extends Controller
{
    public function income(Request $request): View
    {
        ...
        $totalIncomeMasukan = GoodsIn::whereMonth('date_received', $currentMonth)
       ...
       $totalIncome = floor($totalIncomeMasukan - $totalIncomePengeluaran);
       
        return view('admin.master.laporan.income', [
