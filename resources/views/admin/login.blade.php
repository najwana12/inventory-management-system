...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
        <div class="p-2">
          <img src="{{asset('icon2.png')}}" alt="icon"  width="50%">
        </div>
      <div class="card-header text-center">
        <span class="h3" style="text-transform:uppercase; cursor:default;">PT.BSTI</span>
      </div>
      <span class="h5" style="text-transform:uppercase; cursor:default;">LOGIN</span>
        <!--<div class="navbar">
