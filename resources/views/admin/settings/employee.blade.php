                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <small class="text-muted" id="password-help" style="display:none;">
...
<script>
    ...
    function ubah(){
        $.ajax({
            ...
            data:{
                ...
                username:$("#username").val(),
                password:$("#password").val(),
                role_id:$("#role").val(),   // <- PENTING: KIRIM role_id YANG DIPILIH
                "_token":"{{csrf_token()}}"
            },
            success:function(res){
                Swal.fire({
    ...
    $(document).on("click",".ubah",function(){
        ...
        $("#password-help").show(); // kasih info bahwa password boleh kosong
                ...
                $.ajax({
                    ...
                    error:function(err){
                        ...
                        Swal.fire({
                            icon: "error",
                            title: "Error",
                            text: resp && resp.message ? resp.message : "Delete failed"
                        });
                    }
                });
            }
