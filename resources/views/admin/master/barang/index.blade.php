                ...
                <div class="modal fade" id="TambahData" tabindex="-1" aria-labelledby="TambahDataModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="TambahDataModalLabel">{{ __("edit goods") }}</h5>
...
<script>
        ...
        $.ajax({
            ...
            error:function(err){
                ...
                Swal.fire({
                    icon: "error",
                    title: "Update gagal",
                    text: "Cek console / backend controller"
                });
    ...
    $(document).ready(function(){
        ...
        $("#GetFile").val(null);
        $("#outputImg").attr("src", "/default.png");
      ...
      modeEdit = false;
        ...
        // buka modal langsung TANPA trigger tombol tambah
        ...
        $.ajax({
            ...
            if(data.image){
                    $("#outputImg").attr("src", "/storage/barang/" + data.image);
                }else{
                    $("#outputImg").attr("src", "/default.png");
                }
