            ...
            <div class="card w-100">
                <div class="card-header row">
                    <div class="d-flex justify-content-end align-items-center w-100">
                        ...
                        <button class="btn btn-success" type="button"  data-toggle="modal" data-target="#TambahData" id="modal-button"><i class="fas fa-plus"></i> {{__("Tambah Customer")}}</button>
                        @endif
                    </div>
                </div>
                ...
                <div class="modal fade" id="TambahData" tabindex="-1" aria-labelledby="TambahDataModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="TambahDataModalLabel">{{__('tambah data customer')}}</h5>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#modal-button").on("click",function(){
            $("#TambahDataModalLabel").text("{{__('Menambah data customer')}}");
            $("#name").val(null);
            $("#phone_number").val(null);
            $("#address").val(null);
            $("#simpan").text("{{__('save')}}");
